...
public class UserController {
    ...
    public ApiResponse<UserGetAndTicketUserListVo> getUserAndTicketUserList(
            @Valid @RequestBody UserGetAndTicketUserListDto userGetAndTicketUserListDto) {
    ...
    public ApiResponse<Boolean> sendSmsCode(@Valid @RequestBody com.damai.dto.SendSmsCodeDto sendSmsCodeDto) {
        return ApiResponse.ok(userService.sendSmsCode(sendSmsCodeDto));
    }

    @Operation(summary = "短信验证码登录")
    @PostMapping(value = "/sms/login")
    public ApiResponse<UserLoginVo> smsLogin(@Valid @RequestBody com.damai.dto.UserSmsLoginDto userSmsLoginDto) {
        return ApiResponse.ok(userService.smsLogin(userSmsLoginDto));
    }
